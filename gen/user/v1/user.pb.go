...
const file_user_v1_user_proto_rawDesc = "" +
	...
	"\n" +
	"created_at\x18\x05 \x01(\v2\x1a.google.protobuf.TimestampR\tcreatedAt2\xd6\x01\n" +
	"\vUserService\x12<\n" +
	...
	"\n" +
	"CreateUser\x12\x1a.user.v1.CreateUserRequest\x1a\x1b.user.v1.CreateUserResponseB\x17Z\x15grpc-demo/gen/user/v1b\x06proto3"
...
var file_user_v1_user_proto_depIdxs = []int32{
	...
	6, // 1: user.v1.ListUsersResponse.users:type_name -> user.v1.User
	6, // 2: user.v1.CreateUserResponse.user:type_name -> user.v1.User
	...
	1, // 5: user.v1.UserService.ListUsers:input_type -> user.v1.ListUsersRequest
